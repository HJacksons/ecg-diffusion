...
def create_and_save_standardized_12_lead_ecg_plot(number_of_leads_as_input, leads, generated_leads, filename,
                                                  plot_seconds=10, plot_columns=2, plot_range=1.8,
                                                  file_extension='.pdf'):
    ...
    for i in range(0, number_of_leads):
        ...
        plot_second_signal = generated_leads is not None and not (
                    lead_index[t_lead] == "I" or (number_of_leads_as_input == 2 and lead_index[t_lead] == "II"))
